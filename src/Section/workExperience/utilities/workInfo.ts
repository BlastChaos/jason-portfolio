    ...
    langInfo: {
      en: {
        ...
        tasks: [
          ...
          "Rapidly mastered C# and Angular on the job to autonomously manage the backlog, resolving 3+ bugs or features requests per week and ensuring platform stability",
